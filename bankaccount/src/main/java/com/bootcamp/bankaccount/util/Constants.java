...
public class Constants {
  ...
  public static final String MSJ_MONTO_MENOR_APERTURA
          = "Cliente no se registr� porque el monto inicial " +
          "no es mayor a el m�nimo de apertura";
  public static final String MSJ_REQUIERE_TC
          = "Cliente no se registr� porque seg�n el tipo de " +
          "producto requiere tener una tarjeta de cr�dito";
